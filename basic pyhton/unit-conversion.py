...
conversion_type_options = {
    "Length": ["Centimeter to Meter", "Meter to Centimeter", "Centimeter to INCH", "INCH to Centimeter",
               "Centimeter to Km", "KiloMetre to Cm", "Centimeter to Feet", "Feet to Centimeter", "Kilometre to Mile",
               "Mile to Kilometre", "Sqft to Sqmtrs", "Sqft to Acres"],
    "Mass": ["Gram to Kilogram", "Kilogram to Gram", "Kilogram to Tonne", "Tonne to Kilogram", "Milligram to Kilogram",
             "Kilogram to Milligram", "Milligram to Gram", "Gram to Milligram", "kilogram to pound",
             "pound to Kilogram", "Micrograms to gram", "Micrograms to Kg"],
    "Temperature": ["Celsius to Fahrenheit", "Celsius to Kelvin", "Fahrenheit to Celsius", "Fahrenheit to Kelvin",
                    "Kelvin to Celsius", "Kelvin to Fahrenheit"],
    "Time": ["Second to Minute", "Minute to Second", "Second to Hour", "Minute to Hour", "Hour to Minute",
             "Day to Hour", "Hour to Day"],
    "Speed": ["Mile/hour to Km/hour", "Km/hour to Mile/hour", "Mile/hour to Meter/Sec", "Meter/Sec to Mile/hour",
              "Km/hour to Meter/Sec", "Meter/Sec to Km/hour"],
